...
Client::Client()
{
	...
	m_TextureDataFileName = "GemThread\\texture.json";
	m_MeshDataFileName = "GemThread\\mesh.json";
}
...
void Client::Destroy()
{
	...
	SafeDestroy(MazeManager::GetInstance());
...
RESULT Client::Ready_BasicComponent()
{
	...
	cout << "----- Resource Loading Done -----" << endl << endl;
